...
class Institutions:
    def __init__(self, client: APIClient) -> None:
        """
        Initialize the Institutions class with an API client.
    ...
    def get_institutions(
        ...
        """
        Retrieve institution data from the API with specified parameters.
        ...
        """
        if not fields:
            fields = self._load_fields('metadata/institution_properties.yaml')
        params = {
            "filters": filters,
            "fields": fields,
            "sort_by": sort_by,
        ...
        return self.client.get("institutions", params)